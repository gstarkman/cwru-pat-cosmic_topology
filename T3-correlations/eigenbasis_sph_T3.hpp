...
#ifndef EIGENBASIS_SPH_T3_HPP_INCLUDED
#define EIGENBASIS_SPH_T3_HPP_INCLUDED
...
public:
/// 2D arrays listing all necessary integers for a chosen domIndx and condition
        struct retNs {
...
///     input: condition -> index of the set of periodicity conditions to be applied to the sets of ns
        retNs domainNvec();
...
#endif // EIGENBASIS_SPH_T3_HPP_INCLUDED
